/*
 ...
 Source Schema         : cityapi

 Target Server Type    : MySQL
 Target Server Version : 80024
 File Encoding         : 65001

 Date: 13/05/2022 01:05:16
*/
...
CREATE TABLE `barcharts`  (
  ...
  `forecastcount` int(0) NULL DEFAULT NULL,
  `realcount` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `basketballgrounds`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `objectlistId` int(0) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `buildingdetails`  (
  ...
  `malecount` int(0) NULL DEFAULT NULL,
  `femalecount` int(0) NULL DEFAULT NULL,
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `buildings`  (
  ...
  `objectlistId` int(0) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `livecount` int(0) NULL DEFAULT NULL,
  `floorcount` int(0) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `buildings` VALUES (1, 1, 'dep1', 99, 5, '0.66', '2022-03-13 14:25:41', '2022-03-16 17:04:05');
INSERT INTO `buildings` VALUES (2, 1, 'dep2', 6, 2, '1', '2022-03-13 14:25:41', '2022-04-09 07:05:13');
INSERT INTO `buildings` VALUES (3, 1, 'dep3', 38, 6, '0.91', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
INSERT INTO `buildings` VALUES (4, 1, 'dep4', 13, 3, '0.5', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
INSERT INTO `buildings` VALUES (5, 1, 'dep5', 33, 3, '0.33', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
INSERT INTO `buildings` VALUES (6, 1, 'dep6', 4, 2, '1', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
INSERT INTO `buildings` VALUES (7, 1, 'dep7', 38, 5, '1', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
INSERT INTO `buildings` VALUES (8, 1, 'dep8', 70, 5, '0.98', '2022-03-13 14:25:41', '2022-03-13 14:25:41');
...
-- ----------------------------
INSERT INTO `buildstatuses` VALUES (1, 'dep1', 3, '2022-03-20 12:11:30', '2022-05-12 06:19:10');
...
CREATE TABLE `carparks`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `staytime` int(0) NULL DEFAULT NULL,
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `funnelcharts`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `buildingdetailId` int(0) NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `parkings`  (
  ...
  `objectlistId` int(0) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `surpluscount` int(0) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `raycharts` VALUES (1, '雷达图', '小区空气质量检测', 'Morning', 234, 255, 230, 4.09, 123, 100, '2022-03-14 04:08:39', '2022-03-17 15:26:08');
INSERT INTO `raycharts` VALUES (2, '雷达图', '小区空气质量检测', 'Afternoon', 146, 84, 139, 1.094, 40, 17, '2022-03-14 04:08:39', '2022-03-14 04:08:39');
INSERT INTO `raycharts` VALUES (3, '雷达图', '小区空气质量检测', 'Evening', 188, 143, 197, 1.66, 99, 51, '2022-03-14 04:08:39', '2022-03-14 04:08:39');
...
CREATE TABLE `trees`  (
  ...
  `objectlistId` int(0) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `healthycount` int(0) NULL DEFAULT NULL,
  `unhealthycount` int(0) NULL DEFAULT NULL,
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `trucks`  (
  ...
  `objectlistId` int(0) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `kilmeters` int(0) NULL DEFAULT NULL,
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `users` VALUES (21, '叶荣锋', 'admin', 0, '2022-05-08 08:44:32', '2022-05-08 08:44:32');
