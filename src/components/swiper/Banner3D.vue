  ...
  <div class="banner" >
    <div class="bg" ref="bg"
      ...
      <transition name="fade">
        <div class="imgs" v-for="(item, i) in banner"  :key="i" @click="linkTo(item)" @mouseover="stopTimer" @mouseout="startTimer" >
      ...
      banner: [
        {
          ...
          fullUrl: 'http://localhost:8080/static/assets',
          picUrl: '/static/assets/images/swiper.png',
        ...
        },
        {
          ...
          picUrl2: '/static/assets/images/swiper1x.png',
        ...
        },
        {
          ...
          picUrl2: '/static/assets/images/swiper2x.png',
