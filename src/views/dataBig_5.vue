        ...
        <template slot="outer">
          <div flex="dir:top" style="width: 100%">
            ...
            <div class="outer-wrapper">
              ...
              <div class="picture">
                <iframe v-if="isMap" style=" margin-left: 50px" src="https://m.amap.com/navi/?dest=113.23490,23.15600&destName=%E4%B8%96%E6%B3%8A%E7%A7%91%E6%8A%80%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8&&key=97f7c85ab6eef7449537b2b6bd15324c" width="600px" height="400px"></iframe>
                 <!-- <IndexMap style="margin-top: -30px;margin-left:30px"></IndexMap> -->
                <canvas v-if="!isMap" id="canvas" style="height: 400px; margin-top: 30px;margin-left:3px"></canvas> 
              </div>

              <div style="margin-left: 70px" class="bottomBtn" v-if="!isMap">
                <el-select
                  v-model="value"
                  placeholder="请选择"
                  class="select"
                ...
                <el-button
                  type="primary"
                  @click="switchMonitorMap()"
                  
                  style="margin: 10px; margin-left: 10px"
                  >点击切换地图</el-button
                >
              </div>
               ...
               <div style="margin-left: 70px" class="bottomBtn" v-if="isMap">
                ...
                <el-button
                  ...
                  style="margin: 10px; margin-left: 160px"
                  >点击切换监控</el-button
                >
              </div>
          ...
          <div flex="main:justify dir:top" style="height: 100%">
            ...
            <Card>
              <template slot="title" style="z-index: 99">
                <div flex="main:justify">
                  <span>{{ chartTab === 0 ? "车库" : "法人" }}用电量分类统计</span>
